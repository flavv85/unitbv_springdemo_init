INSERT INTO member(member_id, name, nickname)
...
VALUES ('051916c4-291c-4125-9ae7-d045eeece9ea' , SELECT member_id from member where nickname = 'JohnnyR');

INSERT INTO fitness_classes_members(fitness_class_id, member_id)
VALUES ('b7b57d69-d9d0-43bf-a30e-39f682853269', SELECT member_id from member where nickname = 'Norm');

INSERT INTO fitness_classes_members(fitness_class_id, member_id)
VALUES ('b7b57d69-d9d0-43bf-a30e-39f682853269', SELECT member_id from member where nickname = 'Saw');
